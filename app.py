...
app.title = 'DCA Certificate Monitoring Dashboard'
...
navbar = dbc.NavbarSimple(
    ...
    brand="DCA Certificate Monitoring Dashboard",
    brand_href="#",
    color="#242947",
    dark=True,
)
...
], fluid=True, style={'background-color':'white', 'height':'100vh'})
...
def load_google_sheets_data():
    ...
    database = gc.open('DCA Certificate Monitoring')
